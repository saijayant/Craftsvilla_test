...
public class HandpickedRestroAdapter extends RecyclerView.Adapter<HandpickedRestroAdapter.MyViewHolder> {
    ...
    public HandpickedRestroAdapter(ArrayList<Advertise> data, Activity ctx) {
        this.dataSet = data;
        this.mCtx = ctx;
    }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        if (listPosition == 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(mCtx, R.drawable.restro_one));
        }
        if (listPosition == 1) {
            imageView.setImageDrawable(ContextCompat.getDrawable(mCtx, R.drawable.restro_two));
        }
        if (listPosition == 2) {
            imageView.setImageDrawable(ContextCompat.getDrawable(mCtx, R.drawable.restro_three));
        }
        if (listPosition == 3) {
            imageView.setImageDrawable(ContextCompat.getDrawable(mCtx, R.drawable.restro_four));
        }
        if (listPosition == 4) {
            imageView.setImageDrawable(ContextCompat.getDrawable(mCtx, R.drawable.restro_seven));
        }
        if (listPosition == 5) {
            imageView.setImageDrawable(ContextCompat.getDrawable(mCtx, R.drawable.restro_six));
        }
